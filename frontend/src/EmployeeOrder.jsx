...
const EmployeeOrder = () => {
    ...
    const fetchOrders = async () => {
        try {
            const response = await fetch("http://127.0.0.1:5000/active_orders");
    ...
    const handleStatusChange = async (oid, newStatus) => {
        try {
            ...
            const response = await fetch(
                `http://127.0.0.1:5000/active_orders/${oid}/status`,
                {
                    method: "PUT",
                    headers: {
            ...
            <div className="p-4">
                ...
                <div className="flex justify-center">
                    <table className="w-4/5 bg-white border-collapse border border-gray-300">
                        <thead>
                            <tr>
                                <th className="border font-bold text-center px-4 py-2">
                                    Order ID
                                </th>
